...
export default function ViewExam() {
  ...
  const sectionName = pathname.includes("reading") ? "reading" : "listening";
          ...
          <>
            ...
            <div className="text-center flex justify-center items-center gap-6 max-w-3xl mx-auto mt-6">
              <button
                onClick={() =>
                  router.push(
                    `/exams/edit/select-part/${sectionName}?examID=${examID}&partID=${partID}`
                  )
                }
              ...
              {currentQuestionIndex === data.length - 1 ? (
                <button
                  ...
                  onClick={() =>
                    router.push(
                      `/exams/create/select-part/${sectionName}?examID=${examID}&partID=${partID}&from=view`
                    )
                  }
                >
                  Add more questions
